...
export function MonitorSidebar() {
  return (
    <aside className="w-[280px] lg:w-[300px] bg-background-primary border-l border-border-subtle flex flex-col shrink-0 hidden md:flex h-[calc(100vh-64px)] sticky top-16 overflow-y-auto">
      <div className="flex-1 p-5 flex flex-col gap-6">
        ...
        <section>
          ...
          <div className="p-4 bg-background-secondary border border-border-subtle rounded-md shadow-sm">
            <MemoryGauge />
          </div>
        </section>
        ...
        <section>
          ...
          <div className="bg-background-secondary border border-border-subtle rounded-md shadow-sm p-1">
            <ProviderHealth />
          </div>
        </section>
        ...
        <section>
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-[10px] font-semibold uppercase tracking-widest text-text-dim">AI Economics</h3>
          </div>
          <CostTokenDashboard />
        </section>
